...
/*
|--------------------------------------------------------------------------
| Creativearts Config Items
|--------------------------------------------------------------------------
|
| The following items are for use with Creativearts.  The rest of
| the config items are for use with CodeIgniter, some of which are not
| observed by Creativearts, e.g. 'permitted_uri_chars'
|
*/
...
| default system/creativearts/logs/ directory. Use a full server path
| with trailing slash.
|
...
|
| Leave this BLANK unless you would like to set something other than the
| default system/creativearts/cache/ directory. Use a full server path
| with trailing slash.
|
*/
...
/* Location: ./system/creativearts/config/config.php */