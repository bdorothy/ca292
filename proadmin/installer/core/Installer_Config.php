...
class Installer_Config Extends EE_Config {
	...
	function _initialize()
	{
		...
		{
			show_error('Unable to locate your config file (creativearts/config/config.php)');
		}
...
/* Location: ./system/creativearts/installer/libraries/Installer_Config.php */
