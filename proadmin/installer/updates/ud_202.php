...
class Updater {
    ...
    function do_update()
    {
		...
		if (file_exists(APPPATH.'cache/Creativearts_info/version'))
		{
			@unlink(APPPATH.'cache/Creativearts_info/version');
		}
...
/* Location: ./system/creativearts/installer/updates/ud_202.php */