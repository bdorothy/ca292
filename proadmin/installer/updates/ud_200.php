		...
		foreach($query->result_array() as $row)
		{
			foreach($row as $name => $data)
			{
				if (substr($name, -12) == '_preferences')
				{
					...
					{
						$data['doc_url'] = 'http://creativelab.com/creativearts/user-guide/';
					}
...
BSH;
	...
	public function database_changes_weblog()
	{
		...
		{
			// Add in the EE 2 default button set (as determined by creativearts/config/html_buttons.php)
			$buttoncount = 1;
...
/* Location: ./system/creativearts/installer/updates/ud_200.php */
