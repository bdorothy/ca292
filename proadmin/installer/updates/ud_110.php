...
// END CLASS
	...
	function update_skin()
	{
		...
		$str .= '/*'."\n";
		$str .= '====================================================='."\n";
		$str .= ' Creativearts - by Creativelab'."\n";
		$str .= '-----------------------------------------------------'."\n";
		$str .= ' http://creativelab.com/'."\n";
		$str .= '-----------------------------------------------------'."\n";
		$str .= ' Copyright (c) 2003 - 2014, Creativelab, Inc.'."\n";
		$str .= '====================================================='."\n";
		$str .= ' THIS IS COPYRIGHTED SOFTWARE'."\n";
		$str .= ' PLEASE READ THE LICENSE AGREEMENT'."\n";
		$str .= ' http://creativelab.com/creativearts/user-guide/license.html'."\n";
		$str .= '====================================================='."\n";
...
/* Location: ./system/creativearts/installer/updates/ud_110.php */