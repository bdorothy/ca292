...
class Updater {
	...
	/**
	 * Update docs URL if it's still pointing to Creativearts.com
	 */
	private function _update_docs_url()
	{
		if (strpos(ee()->config->item('doc_url'), 'Creativearts.com') !== FALSE)
		{
...
/* Location: ./system/creativearts/installer/updates/ud_254.php */
