...
/**
 * Creativearts Installation and Update Wizard
 *
 * @package		Creativearts
 * @subpackage	Core
 * @category	Core
...
class Wizard extends CI_Controller {
	...
	var $content			= '';
	var $title				= 'Creativearts Installation and Update Wizard';
	var $heading			= 'Creativearts Installation and Update Wizard';
	var $copyright			= 'Copyright 2003 - 2014 Creativelab, Inc. - All Rights Reserved';
	...
	// Native First Party Creativearts Modules (everything else is in third party folder)
	...
	var $userdata = array(
		'app_version'			=> '',
		'doc_url'				=> 'http://creativelab.com/creativearts/user-guide/',
		'ext'					=> '.php',
		'ip'					=> '',
		'database'				=> 'mysql',
		'db_conntype'			=> '0',
...
PAPAYA;
	...
	function _set_output($content = '', $array = array())
	{
		if (IS_CORE)
		{
			$this->heading = str_replace('Creativearts', 'Creativearts Core', $this->heading);
			$this->title = str_replace('Creativearts', 'Creativearts Core', $this->title);
		}
	...
	function _install_accessories()
	{
		...
		$accessories = array('Creativearts_info' => '1.0');
	...
	function _write_config_data()
	{
		...
		$config = array(
			...
			'save_tmpl_files'				=>	'n',
			'tmpl_file_basepath'			=>	realpath('./creativearts/templates/').DIRECTORY_SEPARATOR,
	 ...
	 * @return	null
	 */
	function _write_db_config($db = array(), $active_group = 'Creativearts')
	{
		$prototype = array(
			'hostname'	=> 'localhost',
			'username'	=> '',
...
/* Location: ./system/creativearts/config/database.php */';
...
/* Location: ./system/creativearts/installer/controllers/wizard.php */
