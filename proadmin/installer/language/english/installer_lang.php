...
$lang['your_version'] = 'We have detected that you are currently running Creativearts version %x';
$lang['ready_to_update'] = 'If you are ready to update Creativearts to version %x click the link below:';
$lang['ready_to_install'] = 'If you are ready to install Creativearts version %x click the link below:';
$lang['backup_confirmation'] = 'Did you perform a full backup of your existing Creativearts files and database?';
...
$lang['license_number'] = 'Creativearts License Number';
$lang['locate_license_number'] = 'Available in the <a href="https://store.creativelab.com/manage">download area</a> of the creativelab.com site.';
$lang['invalid_license_number'] = 'The license number provided is not a valid license number.';
$lang['name_of_index'] = 'Name of the index page of your Creativearts site';
...
$lang['sql_dbname_info'] = 'The name of the database where you want Creativearts installed.';
...
$lang['sql_dbname_note'] = 'Note: Please make sure that the database exists, Creativearts will <strong>not</strong> create it for you.';
...
$lang['admin_info'] = 'You will use these settings to access  your Creativearts control panel';
...
$lang['support_resource_info'] = 'If you have questions regarding the above errors please visit our  <a href="http://creativelab.com/support/">Support Resources</a> page or contact Creativearts technical support.';
$lang['click_to_install'] = 'Click here to install a brand new copy of Creativearts';
$lang['click_to_update'] = 'Click here to update Creativearts to Version %s';
$lang['version_update_text'] = 'Running update ...';
$lang['invalid_action'] = 'The action you have requested is not valid.';
$lang['unreadable_config'] = 'Your config.php file is unreadable. Please make sure the file exists and that the file permissions to 666 (or the equivalent write permissions for your server) on the following file: creativearts/config/config.php';
$lang['unwritable_config'] = 'Your config.php file does not appear to have the proper file permissions.  Please set the file permissions to 666 (or the equivalent write permissions for your server) on the following file: creativearts/config/config.php';
$lang['unreadable_database'] = 'Your database.php file is unwriteable. Please make sure the file exists and that the file permissions to 666 (or the equivalent write permissions for your server) on the following file: creativearts/config/database.php';
$lang['unwritable_database'] = 'Your database.php file does not appear to have the proper file permissions.  Please set the file permissions to 666 (or the equivalent write permissions for your server) on the following file: creativearts/config/database.php';
$lang['unwritable_cache_folder'] = 'Your cache folder does not appear to have proper permissions.  Please set the folder permissions to 777 (or the equivalent write permissions for your server) on the following folder: creativearts/cache';
$lang['database_no_config'] = 'Unable to connect to your database using the configuration settings found in the following file: creativearts/config/database.php file. Please correct the settings so that the update can proceed.';
...
$lang['unreadable_update'] = 'Unable to read the contents of your /creativearts/installer/updates directory.  Please check the file permissions and re-run this installation wizard.';
$lang['unreadable_files'] = 'One of your update files is unreadable. Please make sure all of the files located in this folder are readable: creativearts/installer/updates/';
$lang['unreadable_language'] = 'The language files needed for your current language selection (%x) are unavailable. Please put the language pack in this folder: creativearts/language/';
...
$lang['unreadable_schema'] = 'Unable to locate the following folder:  creativearts/installer/schema/  Please upload all components before proceeding.';
$lang['unreadable_dbdriver'] = 'Unable to locate the databae schema file in the following folder:  creativearts/installer/schema/  Please upload all components before proceeding.';
...
$lang['install_detected_msg'] = 'Creativearts appears to already be installed on your database, even though your config and database files are blank.';
$lang['continuing_will_destroy'] = 'Continuing with this installation will destroy ALL information currently in your database.';
$lang['do_not_click_if_updating'] = 'If you are attempting to <strong>UPDATE</strong> Creativearts from a previous version <strong>Do NOT click the button</strong>. Instead, restore your config file first, then run this installation wizard again starting from the first page.';
...
$lang['yes_install_ee'] = 'Yes I am sure.  Install a brand new copy of Creativearts';
$lang['please_stand_by'] = 'Please Stand By...';
$lang['currently_installing'] = 'We are currently updating your Creativearts installation.';
$lang['dont_close_browser'] = 'Do not close your browser until the update routine is finished.';
$lang['ee_has_been_installed'] = 'Creativearts has been successfully installed!';
...
$lang['running_current'] = 'You are now running the most current version of Creativearts!';
$lang['version_warning'] = 'Error: In order to install Creativearts, your server must be running PHP version %x or newer.';
...
$lang['trackback_gone_in_200'] = 'The Trackback module has been removed in Creativearts 2.  You can choose to convert existing trackbacks to comments and/or generate a zip archive containing all existing trackbacks.';
...
$lang['update_ee'] = 'Update Creativearts!';

// surveys
$lang['opt_in_survey'] = 'Opt-in Survey';
$lang['help_with_survey'] = "Please consider helping us make Creativearts better by completing the optional survey for this update.";
...
$lang['what_server_data_is_sent'] = '<p>What data is sent?  Answering yes to this survey question will transmit the following:</p>
									...
									<p>All data is transmitted anonymously and cannot be associated with your local machine, Creativearts user
									account, your site, or your host.</p>';
$lang['show_hide_to_see_server_data'] = 'Show/hide the server data that will be sent';
$lang['would_you_recommend'] = 'How likely is it that you will recommend Creativearts to a colleague or friend?';
$lang['unlikely'] = 'Unlikely';
$lang['highly_likely'] = 'Highly Likely';
$lang['additional_comments'] = 'What could Creativearts or Creativelab do to delight you?';
...
$lang['template_folders_not_located_instr'] = 'Please upload the contents of your 1.x system/templates/ directory to the corresponding system/creativearts/templates/&lt;site_short_name&gt;/  folder and verify permissions on the templates folder is set to 777.';
...
$lang['template_move_errors'] = 'There was an error moving your existing template files to an archive folder.  Please manually move any folders in the form system/creativearts/templates/&lt;site_short_name&gt;/ to a backup location and then %s.';
...
/* Location: ./system/creativearts/installer/language/english/installer_lang.php */
